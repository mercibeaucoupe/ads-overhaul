...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function D(t,e){var r=new a.ɵHttpInterceptingHandler(t,e);return new A(r)}var I=[{provide:a.XhrFactory,useClass:S},{provide:a.HttpHandler,useFactory:D,deps:[a.HttpBackend,r.Injector]}],O=new r.InjectionToken("Server.INITIAL_CONFIG"),C=new r.InjectionToken("Server.RENDER_MODULE_HOOK");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function M(t){var e=c.parse(t);return{hostname:e.hostname||"",protocol:e.protocol||"",port:e.port||"",pathname:e.pathname||"",search:e.search||"",hash:e.hash||""}}var R=function(){function t(t,e){if(this._doc=t,this.href="/",this.hostname="/",this.protocol="/",this.port="/",this.pathname="/",this.search="",this.hash="",this._hashUpdate=new u.Subject,e&&e.url){var r=M(e.url);this.hostname=r.hostname,this.protocol=r.protocol,this.port=r.port,this.pathname=r.pathname,this.search=r.search,this.hash=r.hash}}return t.prototype.getBaseHrefFromDOM=function(){return e.ɵgetDOM().getBaseHref(this._doc)},t.prototype.onPopState=function(t){},t.prototype.onHashChange=function(t){this._hashUpdate.subscribe(t)},Object.defineProperty(t.prototype,"url",{get:function(){return""+this.pathname+this.search+this.hash},enumerable:!0,configurable:!0}),t.prototype.setHash=function(t,e){var r=this;if(this.hash!==t){this.hash=t;var n=this.url;!function o(t){Zone.current.scheduleMicroTask("scheduleMicrotask",t)}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
function K(t,e,r){return function(){var o=t.createElement("script");o.id=e+"-state",o.setAttribute("type","application/json"),o.textContent=n.ɵescapeHtml(r.toJson()),t.body.appendChild(o)}}var X=d([r.NgModule({providers:[n.TransferState,{provide:C,useFactory:K,deps:[e.DOCUMENT,r.APP_ID,n.TransferState],multi:!0}]})],(function X(){}));
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function $(t,e){return t([{provide:O,useValue:{document:e.document,url:e.url}},e.extraProviders?e.extraProviders:[]])}function J(t,e){return e.then((function(e){if(!e.injector.get(n.ɵTRANSITION_ID,null))throw new Error("renderModule[Factory]() requires the use of BrowserModule.withServerTransition() to ensure\nthe server-rendered app can be properly bootstrapped into a client app.");return e.injector.get(r.ApplicationRef).isStable.pipe(l.first((function(t){return t}))).toPromise().then((function(){var n,o,a=t.injector.get(_),i=[],s=e.injector.get(C,null);if(s)try{for(var u=function c(t){var e="function"==typeof Symbol&&t[Symbol.iterator],r=0;return e?e.call(t):{next:function(){return t&&r>=t.length&&(t=void 0),{value:t&&t[r++],done:!t}}}}(s),p=u.next();!p.done;p=u.next()){var l=p.value;try{var f=l();r.ɵisPromise(f)&&i.push(f)}catch(t){console.warn("Ignoring BEFORE_APP_SERIALIZED Exception: ",t)}}}catch(t){n={error:t}}finally{try{p&&!p.done&&(o=u.return)&&o.call(u)}finally{if(n)throw n.error}}var h=function(){var e=a.renderToString();return t.destroy(),e};return 0===i.length?h():Promise.all(i.map((function(t){return t.catch((function(t){console.warn("Ignoring BEFORE_APP_SERIALIZED Exception: ",t)}))}))).then(h)}))}))}
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var Q=new r.Version("9.0.0-rc.3");
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */t.BEFORE_APP_SERIALIZED=C,t.INITIAL_CONFIG=O,t.PlatformState=_,t.ServerModule=G,t.ServerTransferStateModule=X,t.VERSION=Q,t.platformDynamicServer=W,t.platformServer=z,t.renderModule=function Y(t,e){var r=$(W,e);return J(r,r.bootstrapModule(t))},t.renderModuleFactory=function tt(t,e){var r=$(z,e);return J(r,r.bootstrapModuleFactory(t))},t.ɵINTERNAL_SERVER_PLATFORM_PROVIDERS=B,t.ɵSERVER_RENDER_PROVIDERS=Z,t.ɵServerRendererFactory2=P,t.ɵangular_packages_platform_server_platform_server_a=q,t.ɵangular_packages_platform_server_platform_server_b=K,t.ɵangular_packages_platform_server_platform_server_c=k,t.ɵangular_packages_platform_server_platform_server_d=T,t.ɵangular_packages_platform_server_platform_server_e=S,t.ɵangular_packages_platform_server_platform_server_f=D,t.ɵangular_packages_platform_server_platform_server_g=I,Object.defineProperty(t,"__esModule",{value:!0})}));