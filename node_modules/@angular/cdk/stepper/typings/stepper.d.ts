 ...
 * Will be cleared if `aria-label` is set at the same time.
 */>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<CdkStep /**
 * Reference to the element that the tab is labelled by.
 * Will be cleared if `aria-label` is set at the same time.
 */, "cdk-step", ["cdkStep"], { 'editable': "editable", 'optional': "optional", 'completed': "completed", 'hasError': "hasError", 'stepControl': "stepControl", 'label': "label", 'errorMessage': "errorMessage", 'ariaLabel': "aria-label", 'ariaLabelledby': "aria-labelledby", 'state': "state" }, {}, ["stepLabel"]>;
}
