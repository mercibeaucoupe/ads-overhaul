...
const _c4 = [1, "mat-action-row"];
const _c5 = function (a0, a1) { return { collapsedHeight: a0, expandedHeight: a1 }; };
const _c6 = function (a0, a1) { return { value: a0, params: a1 }; };
const _c7 = ["role", "button", 1, "mat-expansion-panel-header"];
function MatExpansionPanelHeader_span_4_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "span", 2);
} if (rf & 2) {
    const ctx_r59 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("@indicatorRotate", ctx_r59._getExpandedState());
} }
const _c8 = [[["mat-panel-title"]], [["mat-panel-description"]], "*"];
const _c9 = ["mat-panel-title", "mat-panel-description", "*"];
const _c10 = [1, "mat-expansion-panel-header-description"];
const _c11 = [1, "mat-expansion-panel-header-title"];
const _c12 = [1, "mat-accordion"];
...
MatExpansionPanel.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MatExpansionPanel, selectors: [["mat-expansion-panel"]], contentQueries: function MatExpansionPanel_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ]), ɵngcc0.ɵɵInheritDefinitionFeature, ɵngcc0.ɵɵNgOnChangesFeature()], ngContentSelectors: _c3, decls: 7, vars: 4, consts: [["role", "region", 1, "mat-expansion-panel-content", 3, "id"], ["body", ""], [1, "mat-expansion-panel-body"], [3, "cdkPortalOutlet"]], template: function MatExpansionPanel_Template(rf, ctx) { if (rf & 1) {
...
MatExpansionPanelActionRow.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MatExpansionPanelActionRow, selectors: [["mat-action-row"]], hostBindings: function MatExpansionPanelActionRow_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
MatExpansionPanelHeader.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MatExpansionPanelHeader, selectors: [["mat-expansion-panel-header"]], hostBindings: function MatExpansionPanelHeader_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵupdateSyntheticHostBinding("@.disabled", ctx._animationsDisabled)("@expansionHeight", ɵngcc0.ɵɵpureFunction2(13, _c6, ctx._getExpandedState(), ɵngcc0.ɵɵpureFunction2(10, _c5, ctx.collapsedHeight, ctx.expandedHeight)));
    ...
    } }, inputs: { expandedHeight: "expandedHeight", collapsedHeight: "collapsedHeight" }, ngContentSelectors: _c9, decls: 5, vars: 1, consts: [[1, "mat-content"], ["class", "mat-expansion-indicator", 4, "ngIf"], [1, "mat-expansion-indicator"]], template: function MatExpansionPanelHeader_Template(rf, ctx) { if (rf & 1) {
...
MatExpansionPanelDescription.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MatExpansionPanelDescription, selectors: [["mat-panel-description"]], hostBindings: function MatExpansionPanelDescription_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
MatExpansionPanelTitle.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MatExpansionPanelTitle, selectors: [["mat-panel-title"]], hostBindings: function MatExpansionPanelTitle_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
