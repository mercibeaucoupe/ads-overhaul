...
const _c4 = ["*", [["mat-option"], ["ng-container"]]];
const _c5 = ["*", "mat-option, ng-container"];
const _c6 = ["role", "option", 1, "mat-option"];
...
NativeDateAdapter.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NativeDateAdapter, factory: function (t) { return NativeDateAdapter.ɵfac(t); }, providedIn: null });
/** @nocollapse */
...
ShowOnDirtyErrorStateMatcher.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ShowOnDirtyErrorStateMatcher, factory: function (t) { return ShowOnDirtyErrorStateMatcher.ɵfac(t); }, providedIn: null });
...
ErrorStateMatcher.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ErrorStateMatcher, factory: function (t) { return ErrorStateMatcher.ɵfac(t); }, providedIn: 'root' });
...
GestureConfig.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: GestureConfig, factory: function (t) { return GestureConfig.ɵfac(t); }, providedIn: null });
/** @nocollapse */
...
MatLine.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MatLine, selectors: [["", "mat-line", ""], ["", "matLine", ""]], hostBindings: function MatLine_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
MatRipple.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MatRipple, selectors: [["", "mat-ripple", ""], ["", "matRipple", ""]], hostBindings: function MatRipple_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
MatPseudoCheckbox.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MatPseudoCheckbox, selectors: [["mat-pseudo-checkbox"]], hostBindings: function MatPseudoCheckbox_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
MatOptgroup.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MatOptgroup, selectors: [["mat-optgroup"]], hostBindings: function MatOptgroup_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
    ...
    } }, inputs: { disabled: "disabled", label: "label" }, exportAs: ["matOptgroup"], features: [ɵngcc0.ɵɵInheritDefinitionFeature], ngContentSelectors: _c5, decls: 4, vars: 2, consts: [[1, "mat-optgroup-label", 3, "id"]], template: function MatOptgroup_Template(rf, ctx) { if (rf & 1) {
...
MatOption.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MatOption, selectors: [["mat-option"]], hostBindings: function MatOption_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
    ...
    } }, inputs: { id: "id", disabled: "disabled", value: "value" }, outputs: { onSelectionChange: "onSelectionChange" }, exportAs: ["matOption"], ngContentSelectors: _c7, decls: 4, vars: 3, consts: [["class", "mat-option-pseudo-checkbox", 3, "state", "disabled", 4, "ngIf"], [1, "mat-option-text"], ["mat-ripple", "", 1, "mat-option-ripple", 3, "matRippleTrigger", "matRippleDisabled"], [1, "mat-option-pseudo-checkbox", 3, "state", "disabled"]], template: function MatOption_Template(rf, ctx) { if (rf & 1) {
