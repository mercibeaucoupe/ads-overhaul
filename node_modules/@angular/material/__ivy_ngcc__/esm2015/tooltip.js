...
MatTooltip.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MatTooltip, selectors: [["", "matTooltip", ""]], hostBindings: function MatTooltip_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
...
TooltipComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: TooltipComponent, selectors: [["mat-tooltip-component"]], hostBindings: function TooltipComponent_HostBindings(rf, ctx, elIndex) { if (rf & 1) {
    ...
    } }, decls: 3, vars: 6, consts: [[1, "mat-tooltip", 3, "ngClass"]], template: function TooltipComponent_Template(rf, ctx) { if (rf & 1) {
